                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="caregiver_type">
                                ...
                                <option value="medical"
                                    {{ old('caregiver_type', $caregiver->caregiver_type ?? '') == 'medical' ? 'selected' : '' }}>
                                    Medical</option>
                                <option value="regular"
                                    {{ old('caregiver_type', $caregiver->caregiver_type ?? '') == 'regular' ? 'selected' : '' }}>
                                    Regular</option>
                                <option value="home_nurse"
                                    {{ old('caregiver_type', $caregiver->caregiver_type ?? '') == 'home_nurse' ? 'selected' : '' }}>
                                    Home Nurse</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="field">
                                ...
                                <option value="Elder care"
                                    {{ old('field', $caregiver->field ?? '') == 'Elder care' ? 'selected' : '' }}>Elder
                                    care</option>
                                <option value="Child care"
                                    {{ old('field', $caregiver->field ?? '') == 'Child care' ? 'selected' : '' }}>Child
                                    care</option>
                                <option value="Therapy"
                                    {{ old('field', $caregiver->field ?? '') == 'Therapy' ? 'selected' : '' }}>Therapy
                                </option>
                                <option value="Lab activity"
                                    {{ old('field', $caregiver->field ?? '') == 'Lab activity' ? 'selected' : '' }}>Lab
                                    activity</option>
                                <option value="Others"
                                    {{ old('field', $caregiver->field ?? '') == 'Others' ? 'selected' : '' }}>Others
                                </option>
                            </select>
                        </div>
