                    ...
                    <div class="card border-0 shadow-sm h-100" style="border-radius: 16px;">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted small mb-1">
                                <i class="bi bi-person me-1"></i> <a href="{{ route('patient.caregiver.show', $booking->caregiver) }}" class="text-decoration-none">{{ optional($booking->caregiver->user)->name ?? '—' }}</a>
                            </p>
                            ...
                            @if($bookingId)
                                ...
                                @if($booking->status === 'completed' && !in_array($booking->booking_id, $reviewedBookingIds ?? []))
