            ...
            <div class="row g-4">
                ...
                <div class="col-md-8">
                    <div class="row g-3">
                        ...
                        @if ($patient && $patient->healthReports && $patient->healthReports->isNotEmpty())
                        <div class="col-12">
                                    ...
                                    @foreach ($patient->healthReports as $report)
                                        ...
                                        <div class="col-12">
                                            ...
                                            @if(in_array($ext, ['jpg', 'jpeg', 'png']))
                                                <img src="{{ route('patient.profile.health-reports.view', $report) }}" alt="Health report" class="img-fluid rounded border" style="max-width: 100%; max-height: 500px; object-fit: contain;">
                                            @else
                                                <iframe src="{{ route('patient.profile.health-reports.view', $report) }}" class="w-100 rounded border" style="height: 500px;" title="{{ $report->original_name ?: 'Health report' }}"></iframe>
                                            @endif
                                        </div>
                                    @endforeach
                                </div>
