    ...
    <div class="card-body p-4">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <p class="mb-0 fw-semibold">@if($booking->caregiver)<a href="{{ route('patient.caregiver.show', $booking->caregiver) }}" class="text-decoration-none">{{ optional($booking->caregiver->user)->name ?? '—' }}</a>@else{{ optional(optional($booking->caregiver)->user)->name ?? '—' }}@endif</p>
            </div>
            <div class="col-md-6">
